  ...
  return (
    ...
    <section className=' tracking-[2px] px-[50px] sm:px-[20px] mt-[60px] sm:mt-[40px] uppercase  flex sm:flex-col flex-row justify-around   '>
        ...
        <div className='flex flex-col justify-center ' >
            <Image className=' md:w-[190px] sm:w-[170px] lg:w-[520.7px]  ' src="/assistes/zimoblack.png" alt="" width={100} height={100}/>
        ...
        <div>
          <Image className=' w-[900px] sm:w-[350px] sm:p-0 p-6 ' src="/assistes/pf1.png" alt=""  width={50} height={50} />
