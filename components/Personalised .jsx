    ...
    <div className=' footer  h-screen flex tracking-[2px]  bg-local  bg-center bg-no-repeat bg-cover' >
        <div className='grid grid-cols-3 text-white uppercase sm:grid-cols-1 3xl:grid-cols-4' >
          <div className='flex flex-col justify-center ' >
            <Image className=' w-[200px] lg:w-[500.74px] lg:ml-[60px] ml-3 ' src="/assistes/f1.png" alt="" width={100} height={100} />
          </div>
          ...
          <div className='   sm:px-[20px] '>
           ...
           <p className='flex  sm:py-3  sm:px-2 sm:justify-start lg:text-[21px]  text-[14px]  lg:mt-[220px] justify-center   '>CREATE USER ID 
           <Image 
           className='w-[44.87px] ml-3 '
           src="/assistes/f2.png" alt="" width={100} height={100} /></p>
          </div>
          </div>
